    ...
    <div>
      ...
      <header id="home" className={styles.home}>
        ...
        <div className={styles.logo_content}>
          <svg className={styles.svg} viewBox="26.453 -27.436 147.035 250">
              <g>
          ...
          <h1 className={styles.title}>ARTAUTO</h1>
          {/* <h2>Lorem ipsum dolor</h2> */}
        </div>

        <div className={styles.top_line}>
          <svg className={styles.svg} viewBox="0 0 1200 120" preserveAspectRatio="none">
      ...
      <section className={styles.content}>
        ...
        <div className={styles.box}>
          <Info id="services" title="PAKALPOJUMI">
            <div className={styles.services}>
              <div className={styles.box}>
                ...
                <h2 className={styles.title}>REMONTS</h2>
                <p className={styles.text}>General Repairs, Electrical Repairs, Specialist Repairs & Computer Diagonostics</p>
                <Link href='/repair'><a className={styles.a}>View</a></Link>
              </div>
              <div className={styles.box}>
                ...
                <h2 className={styles.title}>EVAKUATORS</h2>
                <p className={styles.text}>General Repairs, Electrical Repairs, Specialist Repairs & Computer Diagonostics</p>
                <Link href='/tow-truck'><a className={styles.a}>View</a></Link>
              </div>
              <div className={styles.box}>
                <svg className={styles.svg} viewBox="0 0 512 512">
                <circle cx="256" cy="256" r="246" fillOpacity="0" stroke="var(--color_dark)" strokeOpacity="1" strokeWidth="10"></circle>
                ...
                <h2 className={styles.title}>VEIKALS</h2>
                <p className={styles.text}>General Repairs, Electrical Repairs, Specialist Repairs & Computer Diagonostics</p>
                <Link href='/shop'><a className={styles.a}>View</a></Link>
              </div>
            </div>
          </Info>
          
          <Info id='about-us' title='PAR MUMS' text='PILNA SERVISA AUTOCENTRS PARŪPĒSIES PAR JŪSU MAŠĪNU'>
          ...
          <Info id="gallery" title="GALERIJA">
            <div className={styles.gallery}>
              <div className={styles.wrapper}><section className={styles.wrapper}><Image src="/img/owner.jpg" alt='ARTauto' width={3} height={4} layout="responsive" objectFit="contain" /></section></div>
              ...
              <div className={styles.wrapper}><section className={styles.wrapper}><Image src="/img/serviss.jpg" alt='ARTauto serviss' width={16} height={9} layout="responsive" objectFit="contain" /></section></div>
              <div className={styles.wrapper}><section className={styles.wrapper}><Image src="/img/device1.jpg" alt='ARTauto' width="100%" height="100%" layout="responsive" objectFit="contain" /></section></div>
              <div className={styles.wrapper}><section className={styles.wrapper}><Image src="/img/device3.jpg" alt='ARTauto' width={16} height={9} layout="responsive" objectFit="contain" /></section></div>
              <div className={styles.wrapper}><Image src="/img/autograph.png" alt='ARTauto' width={16} height={9} layout="responsive" objectFit="contain" /></div>
            </div>
          </Info>
          
          <Info id="contact-us" title="KONTAKTI">
