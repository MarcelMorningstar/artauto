...
export default function Home() {
  ...
  return (
    <div>
      <Head>
        <meta name="description" content="ARTauto autoserviss rēzekne parūpēsies par jūsu automašīnu." />
        <title>ARTauto</title>
      </Head>
          ...
          <Info id="services" title={t("common:nav2")}>
            <div className={styles.services}>
              <div className={styles.box}>
                ...
                <h2 className={styles.title}>{t("home:service1")}</h2>
                <p className={styles.text}>General Repairs, Electrical Repairs & Computer Diagonostics</p>
              ...
              <div className={styles.box}>
                ...
                <h2 className={styles.title}>{t("home:service2")}</h2>
              ...
              <div className={styles.box}>
                ...
                <h2 className={styles.title}>{t("home:service3")}</h2>
                <p className={styles.text}>General Repairs, Electrical Repairs, Specialist Repairs & Computer Diagonostics</p>
